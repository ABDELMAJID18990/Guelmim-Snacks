...
// ATTENTION : Leaflet peut avoir des problèmes avec le rendu côté serveur de certains frameworks,
// mais pour un projet client-side pur (Create React App/Vite), c'est parfait.

// Importations nécessaires pour react-leaflet
import { MapContainer, TileLayer, Marker, Popup } from 'react-leaflet';
import 'leaflet/dist/leaflet.css'; // Indispensable pour que la carte s'affiche correctement !

// Petite correction pour que les icônes de leaflet fonctionnent bien avec les outils de build modernes
